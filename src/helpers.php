...
if (!function_exists('admin_path')) {
    ...
    {
        return ucfirst(config('sso.directory')).($path ? DIRECTORY_SEPARATOR.$path : $path);
    }
}
...
if (!function_exists('admin_url')) {
    ...
    function admin_url($path = '', $parameters = [], $secure = null)
    {
        ...
        $secure = $secure ?: (config('sso.https') || config('sso.secure'));
...
if (!function_exists('admin_base_path')) {
    ...
    {
        $prefix = '/'.trim(config('sso.route.prefix'), '/');
...
if (!function_exists('admin_asset')) {
    ...
    {
        return (config('sso.https') || config('sso.secure')) ? secure_asset($path) : asset($path);
    }
}
...
if (!function_exists('admin_get_route')) {
    ...
    {
        return config('sso.route.prefix').'.'.$name;
    }
}
