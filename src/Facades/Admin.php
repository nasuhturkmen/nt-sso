...
namespace NasuhTurkmen\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \NasuhTurkmen\Admin\Grid                                                     grid($model, \Closure $callable)
 * @method static \NasuhTurkmen\Admin\Form                                                     form($model, \Closure $callable)
 * @method static \NasuhTurkmen\Admin\Show                                                     show($model, $callable = null)
 * @method static \NasuhTurkmen\Admin\Tree                                                     tree($model, \Closure $callable = null)
 * @method static \NasuhTurkmen\Admin\Layout\Content                                           content(\Closure $callable = null)
 ...
 *
 * @see \NasuhTurkmen\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \NasuhTurkmen\Admin\Admin::class;
    }
}
